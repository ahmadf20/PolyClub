...
import 'package:poly_club/controllers/user_controller.dart';
        ...
        builder: (c) {
          return Padding(
            padding: const EdgeInsets.fromLTRB(
                25, 10, 25, Const.bottomPaddingButton),
            child: Column(
              ...
              children: [
                ...
                if (user?.id != profileController.user.value.id) ...[
                  ...
                  c.isLoading.value
                      ...
                      : MyTextButton(
                          text: c.user.value.isFollowing ? 'Diikuti' : 'Ikuti',
                          isOutlined: c.user.value.isFollowing,
                          onPressed: () {
                            if (c.user.value.isFollowing) {
                              c.unFollow(user!);
                            } else {
                              c.follow(user!);
                            }
